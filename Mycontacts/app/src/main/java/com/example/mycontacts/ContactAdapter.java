...
public class ContactAdapter extends RecyclerView.Adapter<ContactAdapter.ContactViewHolder> {
   private Contacts[]localContacts;
   private onItemClickListener localListener;

    public ContactAdapter(Contacts[]contacts, onItemClickListener listener){
       localContacts=new Contacts[contacts.length];
    ...
    class ContactViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View view) {
            localListener.onItemCick(getAdapterPosition());
